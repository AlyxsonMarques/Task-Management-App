...
describe('Routes', () => {
  ...
  describe('/me/teams', () => {
    it('POST -> Should create a new team', async () => {})
    it('GET -> Should get all teams', async () => {})
    it('PATCH -> Should update a team', async () => {})
    it('DELETE -> Should delete a team', async () => {})
  })
  describe('/me/teams/:teamId/tasks', () => {
    it('POST -> Should create a new task for a team', async () => {})
    it('GET -> Should get all tasks for a team', async () => {})
    it('PATCH -> Should update a task for a team', async () => {})
    it('DELETE -> Should delete a task for a team', async () => {})
  })
})
